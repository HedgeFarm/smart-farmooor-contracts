...
# eg.:   ./forge_infra deploy btcb localhost 
# eg.:   ./forge_infra deploy btcb localhost-private 
# eg.:   ./forge_infra deploy usdc stge resume 
...
echo "
 _____               _      _____                               
|   __|_____ ___ ___| |_   |   __|___ ___ _____ ___ ___ ___ ___ 
|__   |     | .'|  _|  _|  |   __| .'|  _|     | . | . | . |  _|
|_____|_|_|_|__,|_| |_|    |__|  |__,|_| |_|_|_|___|___|___|_|  
"
...
init_asset() {
    ...
    elif [[ $_asset == "usdt" ]]; then
        export BASE_TOKEN_NAME="USDT"
    elif [[ $_asset == "usdc" ]]; then
        export BASE_TOKEN_NAME="USDC"
    elif [[ $_asset == "savax" ]]; then
